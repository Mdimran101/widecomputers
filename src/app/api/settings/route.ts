  ...
  try {
    ...
    if (!settings) {
      return NextResponse.json({
        brandName: process.env.NEXT_PUBLIC_STORE_NAME || "Wide Computers",
        contact: {
        ...
        marqueeText: "Welcome to Wide Computers!",
        metaTitle: process.env.NEXT_PUBLIC_STORE_NAME || "Wide Computers",
